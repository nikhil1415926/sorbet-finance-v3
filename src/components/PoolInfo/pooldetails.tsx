...
export const PoolDetailComponent: React.FC<PoolDetailProps> = ({ 
  poolDetails,
  guniPool,
  fiatValues
}: PoolDetailProps) => {
    ...
    <>
      {(poolDetails && fiatValues) ?
          <DetailsBox>
            ...
            <p>
              <strong>TVL ($):</strong>{` $${(Number(fiatValues.fiatTotal0) + Number(fiatValues.fiatTotal1)).toLocaleString('en-US')}`}
            </p>
            <p>
            ...
            <p>
              <strong>Your Share ($):</strong>{` $${(Number(fiatValues.fiatShare0) + Number(fiatValues.fiatShare1)).toLocaleString('en-US')}`}
            </p>
            <ButtonsArea>
