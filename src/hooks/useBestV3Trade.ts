...
export function useBestV3TradeExactIn(
  ...
  const quotesResults = useSingleContractMultipleData(quoter, 'quoteExactInput', quoteExactInInputs, undefined, DEFAULT_GAS_QUOTE)
...
export function useBestV3TradeExactOut(
  ...
  const quotesResults = useSingleContractMultipleData(quoter, 'quoteExactOutput', quoteExactOutInputs, undefined, DEFAULT_GAS_QUOTE)
